                        ...
                        <div class="col-xs-12">
                            <table id="simple-table" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th>模块名</th>
                                    <th>颁发主体</th>
                                    <th><i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>到期时间</th>
                                    <th>证书类型</th>
                                    <th>使用环境</th>
                                ...
                                <c:forEach var="cer"   items="${infolist}"   varStatus="index">
                                        ...
                                        <td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${cer.createTime}" /> </td>
                                        <td>
    ...
    $(function(){
        ...
        var options = {
            ...
            pageUrl: function(type, page, current){
                return "${ctx}/cermanager/query?cersendtype="+ ${cersendtype}+"&page="+page;
            }
        }
